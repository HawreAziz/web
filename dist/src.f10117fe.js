...
function () {
  ...
  CollectionView.prototype.render = function () {
    ...
    this.collection.models.forEach(function (user) {
      ...
      _this.renderItem(user, itemParent);
...
function (_super) {
  ...
  UserEdit.prototype.mapRegions = function (fragment) {
    var regions = this.regionsMap();

    for (var regionKey in regions) {
      var element = fragment.querySelector(regions[regionKey]);
...
},{"./View":"src/views/View.ts","./UserShow":"src/views/UserShow.ts","./UserForm":"src/views/UserForm.ts"}],"src/views/UserList.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  UserList.prototype.renderItem = function (user, itemParent) {
    new UserEdit_1.UserEdit(itemParent, user).render();
  };
...
},{"./CollectionView":"src/views/CollectionView.ts","./UserEdit":"src/views/UserEdit.ts"}],"node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/models/SyncApi.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function () {
  function SyncApi(rootURL) {
    this.rootURL = rootURL;
  }

  SyncApi.prototype.save = function (data) {
    var id = data.id;
  ...
  SyncApi.prototype.fetch = function (id) {
...
/** @class */
function () {
  function Model(sync, events, attributes) {
    this.sync = sync;
    this.events = events;
  ...
  Model.prototype.save = function () {
    ...
    this.sync.save(this.attributes.getData()).then(function (response) {
      _this.trigger('save');
          ...
          switch (_a.label) {
            ...
            case 1:
              ...
              response.data.forEach(function (element) {
                var user = _this.deserilize(element);
...
function (_super) {
  ...
  User.buildUser = function (attrs) {
    return new User(new SyncApi_1.SyncApi(rootURL), new Events_1.Events(), new Attributes_1.Attributes(attrs));
  };

  User.buildCollection = function () {
    return new Collection_1.Collection(rootURL, function (element) {
...
exports.User = User;
},{"./SyncApi":"src/models/SyncApi.ts","./Attributes":"src/models/Attributes.ts","./Events":"src/models/Events.ts","./Model":"src/models/Model.ts","./Collection":"src/models/Collection.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
var collection = User_1.User.buildCollection();
...
collection.fetch();
},{"./views/UserList":"src/views/UserList.ts","./models/User":"src/models/User.ts"}],"../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
